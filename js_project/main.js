...
function initDatabase() {
  ...
  streets.forEach(street => db.addStreet(street));
  ...
  services.forEach(service => db.addService(service));
  ...
  charges.forEach(charge => db.addCharge(charge));
